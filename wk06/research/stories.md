...
## Story S3: Contrast
**Situation**: When I'm viewing (tasks/webpages)
**Motivation**: I want [capability/feature]
**Outcome**: So I can easily interact with the interface
**Underlying need**: Because difficulty viewing causes stress for high-demand tasks
...
---
[add additional wcag requirements]
