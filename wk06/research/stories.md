...
**Underlying need**: Because light mode hurts my eyes after very little exposure

**Evidence**: Participant A (notes Q1,5,6)
...
**Underlying need**: Because difficulty viewing outside causes issues with understanding and permenant high contrast becomes unusable after a time

**Evidence**: Participant A (notes Q5), Participant B (notes Q5)
**Inclusion risk**: Cognitive, Screenreader
**Type**: Job story
...
**Underlying need**: Because having to cram important tasks into a short deadline is stressful and has negative implications to my sleep schedule
...
**Underlying need**: Because trying to achieve this is difficult and makes me less likely to use this sort of software

**Evidence**: Participant B (notes Q1,2,3,5)
**Inclusion risk**: Cognitive, Screenreader, Assistive technology
**Type**: Job story
